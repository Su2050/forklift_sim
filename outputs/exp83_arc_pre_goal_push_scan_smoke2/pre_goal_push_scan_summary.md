...
- overlay: `/home/uniubi/projects/forklift_sim/outputs/exp83_arc_pre_goal_push_scan_smoke2/overlay_pre_1p05.png`
- num_cases: `125`
- entry_ok: `125`
...
- overlay: `/home/uniubi/projects/forklift_sim/outputs/exp83_arc_pre_goal_push_scan_smoke2/overlay_pre_2p00.png`
- num_cases: `125`
- entry_ok: `0`
...
- overlay: `/home/uniubi/projects/forklift_sim/outputs/exp83_arc_pre_goal_push_scan_smoke2/overlay_pre_4p00.png`
- num_cases: `125`
- entry_ok: `0`
...
- first row with `num_heading_gt_270 == 0`: `4.0`
- first row with `num_heading_gt_180 == 0`: `4.0`
- first row with `num_length_gt_10m == 0`: `4.0`
